...
item(title='Search' cmd='cmd.exe' args='/c start "" "C:\Program Files\Nilesoft Shell\script\search.bat"' image='C:\Program Files\Nilesoft Shell\icons\search.ico')
item(title='Draw' cmd='cmd.exe' args='/c start "" "C:\Program Files\Nilesoft Shell\script\draw.py"' image='C:\Program Files\Nilesoft Shell\icons\draw.ico')
item(title='wallpaper' cmd='cmd.exe' args='/c start "" "C:\Program Files\Nilesoft Shell\script\wallpaper.py"' image='C:\Program Files\Nilesoft Shell\icons\wallpaper.ico')
