...
ICON_PATH = r"C:\Program Files\ima menu\icons\theme.ico"
THEME_PATH = r"c:\program files\ima menu\imports\theme.nss"
...
class ThemeEditor(QMainWindow):
    ...
    def save_theme(self):
        try:
            ...
            # Delay and perform Ctrl+Right Click after 300 milliseconds
