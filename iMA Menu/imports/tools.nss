menu(find='.mkv|.mp4|.webm|.flv|.m4p|.mov|.png|.jpg|.jpeg|.svg|.webp|.bmp|.ico' title='Tools' image =\uE0F8)
{
    ...
    item(find='.mkv|.mp4|.webm|.flv|.m4p|.mov'
    title='MP4 to MP3' cmd='cmd.exe' args='/c echo @sel.path | clip & start "" "@app.dir\script\mp4-3.bat"' image=\uE154)

    item(find='.mkv|.mp4|.webm|.flv|.m4p|.mov'
    title='Video to Gif' cmd='cmd.exe' args='/c echo @sel.path | clip & start "" "@app.dir\script\vid2gif.bat"' image=\uE1F9)

    item(find='.mkv|.mp4|.webm|.flv|.m4p|.mov|.png|.jpg|.jpeg|.svg|.webp|.bmp|.ico'
